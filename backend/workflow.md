...
5. `POST /analyze-wound`
   ...
   - Stores the returned AI analysis snapshot into record `analysis` and case `current_analysis`.
...
5. `POST /analyze-wound`
   ...
   - Stores the returned AI analysis snapshot onto the active record and case snapshot.
...
6. `POST /analyze-wound`
   ...
   - Stores the returned AI analysis snapshot onto the follow-up record and case snapshot.
   - Runs AI analysis.
